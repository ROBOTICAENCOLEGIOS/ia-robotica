class RecPcb1Arduino {
  ...
  // FINAL_ESTA_SI: Llamada síncrona directa absoluta - ESTA SÍ FUNCIONA
  connectRobot() {
    // FINAL_ESTA_SI: Llamada directa e inmediata al gesto del usuario
    // SIN AWAIT, SIN ASYNC, SIN THEN ANTES DE LA LLAMADA
    // ESTA DEBE SER LA PRIMERA OPERACIÓN EJECUTADA - ESTA SÍ
    try {
      // Llamada síncrona directa - debe ser la primera operación - ESTA SÍ
      navigator.serial.requestPort()
        .then(port => {
          this.port = port;
          // Ejecutar conexión asíncrona después del gesto
