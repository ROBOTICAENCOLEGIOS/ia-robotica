class RecPcb1Arduino {
  ...
  // FINAL5: Llamada síncrona directa absoluta - sin ninguna promesa antes
  connectRobot() {
    // FINAL5: Llamada directa e inmediata al gesto del usuario
    // SIN AWAIT, SIN ASYNC, SIN THEN ANTES DE LA LLAMADA
    // ESTA DEBE SER LA PRIMERA OPERACIÓN EJECUTADA
    try {
      ...
      // Manejar la promesa DESPUÉS de la llamada síncrona
      port.then(selectedPort => {
