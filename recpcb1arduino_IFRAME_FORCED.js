...
class RecPcb1Arduino { 
  ...
  // CÓDIGO DE VISIBILIDAD EXACTO: Forzar iframe a pantalla completa
  _createOverlayButton() {
    if (window.frameElement) {
      this._oldStyle = window.frameElement.style.cssText;
      // Esto obliga al iframe que contiene la extensión a saltar al frente y cubrir todo
      window.frameElement.style.cssText = 'position:fixed !important; top:0 !important; left:0 !important; width:100vw !important; height:100vh !important; z-index:2147483647 !important; border:none !important; display:block !important;';
    }
    
    const btn = document.createElement('div');
    btn.style.cssText = 'position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(255,0,0,0.9); color:white; display:flex; flex-direction:column; align-items:center; justify-content:center; z-index:2147483647; cursor:pointer; font-family:sans-serif;';
    btn.innerHTML = '<h1 style="font-size:40px;">CONECTAR ROBOT</h1><p style="font-size:24px;">HAZ CLIC AQUÍ PARA HABILITAR EL PUERTO SERIAL</p>';
    ...
    this._overlayButton = btn;
  }

  // RESTAURAR: Devolver iframe a tamaño original
    ...
    try {
      navigator.serial.requestPort()
        ...
        .catch(e => {
          ...
          if (this._overlayButton) {
            this._overlayButton.innerHTML = '<h1 style="font-size:40px;">ERROR AL CONECTAR</h1><p style="font-size:24px;">HAZ CLIC PARA REINTENTAR</p>';
          }
        });
    } catch (e) {
      ...
      this._createOverlayButton();
      if (this._overlayButton) {
        this._overlayButton.innerHTML = '<h1 style="font-size:40px;">ERROR CRÍTICO</h1><p style="font-size:24px;">RECARGUE LA PÁGINA</p>';
      }
    }
  }
