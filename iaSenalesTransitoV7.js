class IASenalesTransitoV7 {
  ...
  // ABSOLUTE SYNC: Primera línea de ejecución = acceso directo al hardware
  start() {
    if (!this.model) {
    ...
    // ABSOLUTE SYNC: PRIMERA LÍNEA DE EJECUCIÓN REAL = ACCESO AL HARDWARE
    // SIN AWAIT, SIN setTimeout, SIN PROMESAS EXTERNAS
    try {
