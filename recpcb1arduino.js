class RecPcb1Arduino {
  ...
  // MÉTODO FINAL3: Llamada síncrona directa sin ninguna promesa antes
  connectRobot() {
    // Llamada directa e inmediata - sin await, sin then, sin async
    const requestPort = () => {
      try {
        // Llamada síncrona directa al gesto del usuario
